...
uint256 hashGenesisBlock("0xe81afc28253216de6ab535876eeaa67e640f9778f97594288ca9252e99f1f316");
...
static const int64 nTargetSpacing = 20; // vrilcoin: 20 second blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe81afc28253216de6ab535876eeaa67e640f9778f97594288ca9252e99f1f316");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "On this day During World War II, American forces on Wake Island surrendered to the Japanese";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388164163; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1148624;

        if (fTestNet)
        {
            block.nTime    = 1387847896;
            block.nNonce   = 114862;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe3644e01a6e848355404aaaff80cced0fbf4422a9ebdb0197440b7cc2b85ed5a"));
